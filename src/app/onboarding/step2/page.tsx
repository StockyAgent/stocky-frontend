  ...
  return (
    <div className="relative flex min-h-dvh flex-col bg-[#0d0d0d]">
      ...
      <div className="flex-1 px-4 pb-44">
        ...
        <div className="flex items-center justify-between px-1 py-2.5">
          <div className="flex items-center gap-2">
            ...
            <div className="flex rounded-full border border-white/10 bg-card-bg p-[3px]">
              <button
        ...
        <div className="flex items-center justify-center gap-2 py-12">
          ...
          <span className="text-sm font-light text-gray-500">데이터 로드 중...</span>
        </div>
      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-30 bg-gradient-to-t from-[#0d0d0d] via-[#0d0d0d] to-transparent pb-8 pt-5 flex justify-center px-5">
        <PrimaryButton disabled={selectedStocks.size === 0}>
          Stocky 시작하기
        </PrimaryButton>
      </div>
    </div>
