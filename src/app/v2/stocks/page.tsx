        ...
        {filtered.map((stock) => {
          ...
          return (
            <button
              ...
              className={`flex w-full items-center gap-3 rounded-[16px] border-2 px-4 py-3.5 text-left transition-all duration-300 ${
                isSel
                  ? "-translate-y-1 border-[#1cb863] bg-[#edfaf3] shadow-[0_4px_0_#b8efd0]"
